...
struct TableSelectionView2: View {
...
#Preview {
    TableSelectionView2(canteenData:  CanteenData (name: "Canteen 2", description: "โรงร้อน", images: ["canteen21", "canteen22", "canteen23"], tableCount: 44, rating: "Your rating", folderName: "canteen2", time: ["11:25", "11:55", "12:20", "12:45", "13:05", "13:30"], canteenImages: ["canteen21", "canteen22", "canteen23"]), userId: .constant(""))
}
